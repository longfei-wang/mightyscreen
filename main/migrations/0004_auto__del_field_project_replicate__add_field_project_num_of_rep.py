...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'project.replicate'
        db.delete_column(u'main_project', 'replicate')

        # Adding field 'project.num_of_rep'
        db.add_column(u'main_project', 'num_of_rep',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'project.replicate'
        db.add_column(u'main_project', 'replicate',
                      self.gf('django.db.models.fields.TextField')(default='abc'),
                      keep_default=False)

        # Deleting field 'project.num_of_rep'
        db.delete_column(u'main_project', 'num_of_rep')
    ...
    models = {
        ...
        u'main.project': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'num_of_rep': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
