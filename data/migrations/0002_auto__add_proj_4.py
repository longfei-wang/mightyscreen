...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_proj_4', (
            ...
            ('FP_3', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('FP_4', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('FI_3', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('FI_4', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('PC_3', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('PC_4', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('SC_3', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('SC_4', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('zscore', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
        db.send_create_signal(u'data', ['proj_4'])


    def backwards(self, orm):
        # Deleting model 'proj_4'
        db.delete_table(u'data_proj_4')
