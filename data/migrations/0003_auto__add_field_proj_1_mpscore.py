...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'proj_1.mpscore'
        db.add_column(u'data_proj_1', 'mpscore',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'proj_1.mpscore'
        db.delete_column(u'data_proj_1', 'mpscore')
    ...
    models = {
        ...
        u'data.proj_1': {
            ...
            'mpscore': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
