...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_proj_1', (
            ...
            ('FP_B', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('FI_A', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('FI_B', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('PC_A', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('PC_B', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('SC_A', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('SC_B', self.gf('django.db.models.fields.FloatField')(null=True)),
