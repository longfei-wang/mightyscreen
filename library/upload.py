...
#def test_2():
#    lib.parse()
#    parsed_lib = lib.get_parsed_lib()
#    for l in parsed_lib[:5]:
#        print l['TPSA']
#
#def test_3():
#    lib.updateAndParse()
...
#
#def test_4():
#    lib.updateAndParse(debug = True)
#    parsed_lib = lib.get_parsed_lib()
#    for l in parsed_lib[:5]:
#        print l['Chemical_Name']
#
#def test_5():
#    lib.updateAndParse(debug = True)
#    lib.writeParsed(debug = True)
#    parsed_lib = lib.get_parsed_lib()
#    input_keys_number = len(parsed_lib[0].keys())
#    fps = []
#    for l in parsed_lib[:2]:
#        fps.append(l['Fp2'])
#    fp1 = lib._ascii_to_fp(fps[0])
#    fp2 = lib._ascii_to_fp(fps[1])
#    tanimoto1 = lib._tanimoto(fp1,fp2)
#    
#    
#    load_output = open('testset_ICCB_parsed.json','rU')
#    a= []
...
#    fp1 = lib._ascii_to_fp(fps[0])
#    fp2 = lib._ascii_to_fp(fps[1])
#    tanimoto2 = lib._tanimoto(fp1,fp2)
#    
#    output_keys_number = len(a[0].keys())        
#    if input_keys_number == output_keys_number:
#        print 'Pass \nLibrary and parsed output have same number of keys'
#    else:
#        print 'Fail'
#    
#    if tanimoto1 == tanimoto2:
#        print 'Pass \nLibrary and parsed output have same FP2 type finger print'
#    else:
#        print 'Fail'
##    print tanimoto1
#
#def test_n():
#    '''to test whether the finger print could generate right Tanimoto coefficience'''
#    lib.updateAndParse()
#    parsed_lib = lib.get_parsed_lib()
#    fps = []
#    for l in parsed_lib[:5]:
#        fps.append(l['Fp2'])
#    fp1 = ascii_to_fp(fps[0])
#    fp2 = ascii_to_fp(fps[1])
